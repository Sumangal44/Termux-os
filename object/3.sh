...
clear;toilet -t -f mono12  "SUMANGAL44" --gay -F border
echo ""
PUT 11 40
echo -e "\e[92mBy\e[1;93m sumangal karan\e[1;95m /\e[1;96m SUMANGAL44 "
PUT 12 3
echo ""
echo -e "\e[1;31m  [\e[32m√\e[31m] \e[1;91m by \e[1;36msumangal karan \e[93m/ \e[100;92myoutube.com/sumangalkaran\e[0m"
echo
...
sed -e "s/\SUMANGAL44/$name/g" .h4Ck3r.zsh-theme > $HOME/.oh-my-zsh/themes/h4Ck3r.zsh-theme